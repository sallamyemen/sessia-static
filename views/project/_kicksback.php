    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-10 offset-xl-1">
                ...
                <div class="project-kicksback-1__subtitle wow slideInLeft">
        ...
        <div class="row project-kicksback-1__description">
            <div class="col-xl-3 offset-xl-1 col-lg-4">
                <div class="project-kicksback-1__text-1 wow slideInLeft">
            ...
            <div class="col-xxl-3 col-lg-4">
                <div class="project-kicksback-1__text-2 wow slideInRight">
                ...
                <div class="project-kicksback-1__text-3 wow slideInRight">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-4 offset-xl-4 col-md-6 offset-md-3 col-sm-8 offset-sm-2">
                <div class="project-kicksback-2__title">
                    <?= Yii::t('app', 'Что такое кикcбэк?') ?>
                </div>
                <div class="project-kicksback-2__text">
    ...
    <div class="container">
        <div class="row">
            <div class="col-xl-8 offset-xl-2 col-lg-10 offset-lg-1">
                <div class="project-kicksback-3__subtitle wow fadeIn">
                    <?= Yii::t('app', 'Успешный бизнес {br}вместе с&nbsp;приложением', ['br' => '<br>']) ?>
                </div>
                <div class="project-kicksback-3__title" style="background-image: url('<?= Url::to('@web/storage/project/kicksback/image-3.svg?v=1') ?>')"></div>
                <div class="project-kicksback-3__info">
                    <div class="project-kicksback-3__links">
                    ...
                    <div class="project-kicksback-3__text">
